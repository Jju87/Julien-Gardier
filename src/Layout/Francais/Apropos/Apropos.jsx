            ...
            <div className="a-propos__content">
                ...
                <div className="a-propos__content--text">
                    ...
                    <article>
                        ...
                        <p>Je suis très attentif aux détails, et j'aime reproduire avec précision des maquettes graphiques.</p>
                        <p>Je suis très à l'aise avec les technologies front-end, mais grâce à ma dernière formation avec OpenClassrooms, j'ai également pu acquérir de solides bases en back-end.</p>
                    </article>
                </div>
            </div>
        </section>
